...
bt_fits = {7: {"FUV": (0.2421, 0.7544), "NUV": (0.1579, 0.6701),
           ...
           8: {"FUV": (0.1655, 0.6713), "NUV": (0.1080, 0.6135),
               "U": (0.0500, 0.5660), "B": (0.0067, 0.5608),
               "V": (-0.0081, 0.5535), "I": (-0.0243, 0.5314),
               "Z": (-0.0251, 0.5161), "Y": (-0.0266, 0.5201),
               "J": (-0.0399, 0.5122), "H": (-0.0473, 0.5019)}
           }
