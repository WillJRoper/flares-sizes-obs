...
fig.savefig('plots/LuminCentred_Img_HalfLightRadiusFUV_soft.png', bbox_inches='tight')
...
fig.savefig('plots/LuminCentred_Img_HalfLightRadiusFUV.png', bbox_inches='tight')
...
for snap in snaps:
    ...
    fig.savefig('plots/LuminCentred_Img_HalfLightRadiusFUV_' + str(z) + '.png', bbox_inches='tight')
