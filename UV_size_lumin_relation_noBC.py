...
if run:
    ...
    reg_dict = phot.get_lum(reg, kappa=0.0795, tag=tag, BC_fac=0.0,
    ...
    for f in filters:
        ...
        for ind in range(len(begin)):
            ...
            this_gdust = this_dtm * gas_Z[gb: ge][gbool] * gas_masses[gb: ge][
                gbool]
    ...
    hdf = h5py.File(
        "data/flares_sizes_noBC_{}_{}_{}_{}_{}.hdf5".format(reg, tag,
                                                            Type,
                                                            orientation,
                                                            f.split(".")[-1]),
        "w")
    ...
    for f in filters:
        ...
        try:
            dset = f_group.create_dataset("Image_Luminosity_No_Smooth",
                                          data=nosmooth_img_lumins,
        ...
        try:
            dset = f_group.create_dataset("No_Smooth_Images",
                                          data=nosmooth_imgs,
        ...
        for r in radii_fracs:
            ...
            try:
                dset = f_group.create_dataset(
                    "HLR_Aperture_%.1f_No_Smooth" % r,
            ...
            try:
                ...
                print("HLR_Pixel_%.1f_No_Smooth" % r,
                      "already exists: Overwriting...")
