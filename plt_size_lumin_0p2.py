...
for reg, snap in reg_snaps:
    ...
    for f in filters:
        ...
        hlr_dict[snap][f].extend(orientation_group[f]["HLR_0.2"][...][okinds])
        hlr_app_dict[snap][f].extend(
            orientation_group[f]["HLR_Aperture_0.2"][...][okinds])
        hlr_pix_dict[snap][f].extend(
            orientation_group[f]["HLR_Pixel_0.2"][...][okinds])
...
for f in filters:
    ...
    for snap in snaps:
        ...
        fig.savefig(
            'plots/' + str(z) + '/20%Radius_' + f + '_' + str(
                z) + '_'
        ...
        fig.savefig('plots/' + str(z) + '/20%RadiusAperture_'
        ...
        fig.savefig('plots/' + str(z) + '/20%RadiusPixel_'
                    + f + '_' + str(z) + '_' + orientation
                    + '_' + Type + "_" + extinction + "_"
                    + '%d.png' % nlim,
                    bbox_inches='tight')
